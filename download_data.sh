...
LABS=("ARMA" "Animation" "AnisotropicDiffusion" "BinaryTrees" "BreadthFirstSearch" "CDHMM" "CVXPY_Intro" "Conditioning_Stability" "DataCleaning" "DataVisualization" "Differentiation" "DrazinInverse" "Exceptions_FileIO" "FacialRecognition" "FourierTransform" "GMM" "Gibbs_LDA" "GradientMethods" "HMM" "ImageSegmentation" "InformationTheory" "InteriorPoint_Linear" "InteriorPoint_Quadratic" "InverseProblem" "KMeans" "LSI_SkLearn" "LeastSquares_Eigenvalues" "LinearRegression" "LinearTransformations" "LinkedLists" "MarkovChains" "MatplotlibIntro" "Metropolis" "NMF" "NMF_Recommender" "NaiveBayes" "NearestNeighbor" "NumpyIntro" "PageRank" "Pandas1" "Pandas2" "Pandas3" "Pandas4" "PoissonEquation" "PolynomialInterpolation" "Profiling" "RNN" "RandomForest" "RegularExpressions" "SIR_Models" "SQL1" "SQL2" "SVD_ImageCompression" "Simplex" "Spark" "TotalVariation" "UnixShell1" "UnixShell2" "Wavelets" "WebScraping")
